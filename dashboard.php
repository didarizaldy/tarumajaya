			...
			<div class="sidebar-collapse">
				<ul class="nav" id="main-menu">
					<li class="text-center">
						<img src="assets/img/ttj2.png" class="user-image img-responsive" width="50%" />
					</li>
		...
		<div id="page-wrapper">
			<div id="page-inner">
				<div class="row">
					<div class="col-md-12">
						<marquee>
							<b>- SISTEM INFORMASI PENGADUAN MASYARAKAT PEDESAAN BERBASIS WEBSITE | FITUR TAMBAHAN YANG ADA PADA APLIKASI INI MENGGUNAKAN
